      ...
      <View style={[styles.content, { paddingTop: insets.top + SPACING.lg }]}>
        <GlassCard style={styles.headerCard} opacity={OPACITY.glass}>
          ...
          <Text style={styles.subtitle}>
            Discover perfect activities for your outings together 📅
          </Text>
        </GlassCard>
        ...
        <GlassCard style={styles.featureCard} opacity={OPACITY.glass}>
          ...
          <Text style={styles.featureDescription}>
            Explore a curated list of date ideas. Swipe right on activities
            you'd enjoy and find the perfect date night!
          </Text>
        </GlassCard>
      </View>
    </SafeAreaView>
