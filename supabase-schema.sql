...
('On a scale of 1-10, how listened to do you feel in our relationship?', 'communication', 'scale', NULL, 1, 10, '{"min": "Not heard at all", "max": "Perfectly heard"}', NOW()),
...
('On a scale of 1-10, how important is laughter in our communication?', 'communication', 'scale', NULL, 1, 10, '{"min": "Not important", "max": "Essential"}', NOW()),
...
('On a scale of 1-10, how important is political and social engagement to you?', 'values', 'scale', NULL, 1, 10, '{"min": "Not at all", "max": "Extremely"}', NOW()),
...
('On a scale of 1-10, how important is it for you that we share the same core values?', 'values', 'scale', NULL, 1, 10, '{"min": "Not so important", "max": "Absolutely crucial"}', NOW()),
...
('On a scale of 1-10, how much do you enjoy sports activities?', 'hobbies', 'scale', NULL, 1, 10, '{"min": "I hate them", "max": "I love them"}', NOW()),
...
('On a scale of 1-10, how creative are you?', 'hobbies', 'scale', NULL, 1, 10, '{"min": "Not at all", "max": "Very creative"}', NOW()),
...
('On a scale of 1-10, how satisfied are you with our intimate life?', 'intimacy', 'scale', NULL, 1, 10, '{"min": "Not at all satisfied", "max": "Very satisfied"}', NOW()),
...
('On a scale of 1-10, how easy is it for you to talk about your desires and boundaries?', 'intimacy', 'scale', NULL, 1, 10, '{"min": "Very difficult", "max": "Very easy"}', NOW()),
...
('On a scale of 1-10, how well do you get along with my family?', 'family', 'scale', NULL, 1, 10, '{"min": "Not at all", "max": "Very well"}', NOW()),
...
('On a scale of 1-10, how much do your family''s opinions influence your major decisions?', 'family', 'scale', NULL, 1, 10, '{"min": "Not at all", "max": "A great deal"}', NOW()),
...
('On a scale of 1-10, how aligned are our career goals?', 'future', 'scale', NULL, 1, 10, '{"min": "Not at all aligned", "max": "Perfectly aligned"}', NOW()),
...
('On a scale of 1-10, how willing are you to make sacrifices for my future goals?', 'future', 'scale', NULL, 1, 10, '{"min": "Not at all willing", "max": "Completely willing"}', NOW()),
...
('On a scale of 1-10, how much do you enjoy trying new restaurants?', 'activities', 'scale', NULL, 1, 10, '{"min": "Not at all", "max": "I love it"}', NOW()),
...
('On a scale of 1-10, how much do you enjoy lively parties?', 'activities', 'scale', NULL, 1, 10, '{"min": "I prefer to stay home", "max": "I love to go out"}', NOW()),
...
-- Physical
('On a scale of 1-10, how important is physical attraction in a relationship for you?', 'physical', 'scale', NULL, 1, 10, '{"min": "Not very important", "max": "Very important"}', NOW()),
...
('On a scale of 1-10, how satisfied are you with your own physical appearance?', 'physical', 'scale', NULL, 1, 10, '{"min": "Not at all satisfied", "max": "Very satisfied"}', NOW()),
...
('On a scale of 1-10, how important are surprises to you on a date?', 'dates', 'scale', NULL, 1, 10, '{"min": "I don''t like surprises", "max": "I love surprises"}', NOW()),
...
('On a scale of 1-10, how important is it to dress up for a date?', 'dates', 'scale', NULL, 1, 10, '{"min": "Not at all important", "max": "Very important"}', NOW()),
...
('On a scale of 1-10, how spontaneous are you?', 'personality', 'scale', NULL, 1, 10, '{"min": "Not at all spontaneous", "max": "Very spontaneous"}', NOW()),
...
('On a scale of 1-10, how neat and organized are you?', 'personality', 'scale', NULL, 1, 10, '{"min": "Very messy", "max": "Very organized"}', NOW()),
